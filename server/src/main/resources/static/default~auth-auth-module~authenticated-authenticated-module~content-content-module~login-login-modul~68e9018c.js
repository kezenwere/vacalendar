(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~auth-auth-module~authenticated-authenticated-module~content-content-module~login-login-modul~68e9018c"],{
...
/***/ "./src/app/shared/service/abstract-http-client/abstract-http-client.service.ts":
/*!*************************************************************************************!*\
  !*** ./src/app/shared/service/abstract-http-client/abstract-http-client.service.ts ***!
  \*************************************************************************************/
/*! exports provided: AbstractHttpClientService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AbstractHttpClientService", function() { return AbstractHttpClientService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _server_response__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./server-response */ "./src/app/shared/service/abstract-http-client/server-response.ts");
...
/* harmony import */ var _app_constants_app_constants_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../app-constants/app-constants.service */ "./src/app/shared/service/app-constants/app-constants.service.ts");
/* harmony import */ var _app_wide_service_app_wide_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../app-wide-service/app-wide.service */ "./src/app/shared/service/app-wide-service/app-wide.service.ts");
...
var AbstractHttpClientService = /** @class */ (function () {
    function AbstractHttpClientService(resource, ContentType, http, appWideService, authUtilService, appConstantsService) {
    ...
    /////////////    GET /////////////////////////////////
    AbstractHttpClientService.prototype.get = function (node, params, headers) {
        if (node === void 0) { node = ''; }
        var url = this.buildRelativeUrl(this.resource, node);
        console.log('GET URL: ', url);
        return this.http.get(url, this.buildRequestOptions(params, headers));
    };
    /////////////    PUT /////////////////////////////////
    AbstractHttpClientService.prototype.put = function (payload, node, params, headers) {
        if (node === void 0) { node = ''; }
        var url = this.buildRelativeUrl(this.resource, node);
        console.log('PUT URL', url);
        console.log('Raw Payload: ', payload);
        return this.http.put(url, payload, this.buildRequestOptions());
    };
    /////////////    PATCH /////////////////////////////////
    AbstractHttpClientService.prototype.patch = function (payload, node, params, headers) {
        if (node === void 0) { node = ''; }
        var url = this.buildRelativeUrl(this.resource, node);
        console.log('PATCH URL', url);
        console.log('Raw Payload: ', this.payload);
        return this.http.patch(url, payload, this.buildRequestOptions());
    };
    /////////////    DELETE /////////////////////////////////
    AbstractHttpClientService.prototype.delete = function (node, params, headers) {
        var url = this.buildRelativeUrl(this.resource, node);
        console.log('Delete URL', url);
        return this.http.delete(url, this.buildRequestOptions());
    };
    /////////////    POST /////////////////////////////////
    AbstractHttpClientService.prototype.post = function (payload, node, params, headers, reportProgress) {
        if (node === void 0) { node = ''; }
        if (reportProgress === void 0) { reportProgress = false; }
        var url = this.buildRelativeUrl(this.resource, node);
        console.log('POST URL: ', url);
        console.log('Raw payload: ', payload);
        return this.http.post(url, payload, this.buildRequestOptions());
    };
    /////////////    POST WITH PROGRESS/////////////////////////////////
    AbstractHttpClientService.prototype.postWithProgress = function (node, payload) {
        if (node === void 0) { node = ''; }
    ...
    // }
    ////////////////////////////////////////////////////////////////////////////////////
    AbstractHttpClientService.prototype.testRequest = function () {
        this.http.get('/')
            .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_8__["retry"])(3), Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_8__["catchError"])(this.handleError))
    ...
    //   }
    ////////////////////////////////// HELPER METHODS /////////////////////////////////
    AbstractHttpClientService.prototype.buildRequestOptions = function (params, headers) {
    ...
    AbstractHttpClientService.prototype.buildFullUrl = function (base, resource, node) {
        return base
            + (resource ? '/' + resource : '')
            + (node ? '/' + node : '');
    };
    AbstractHttpClientService.prototype.buildRelativeUrl = function (resource, node) {
        return this.baseUrl + (resource ? resource : '') + (node ? '/' + node : '');
    };
    AbstractHttpClientService.prototype.payloadEncode = function (obj) {
        if (this.ContentType === _app_constants_app_constants_service__WEBPACK_IMPORTED_MODULE_5__["AppConstantsService"].REQUEST_HEADER_CONTENT_TYPE_FORM_URLENCODED) {
    ...
    AbstractHttpClientService.prototype.extractData = function (res) {
        console.log('Server response: ', res);
        var jwtToken = res.headers.get(_app_constants_app_constants_service__WEBPACK_IMPORTED_MODULE_5__["AppConstantsService"].JWT_HEADER_NAME);
        console.log('token: ', jwtToken);
        saveJwtToken(jwtToken);
        saveLastActiveTime();
        var body = res.json() || {};
        var response = new _server_response__WEBPACK_IMPORTED_MODULE_2__["ServerResponse"]();
        response.data = body;
        return response;
        function saveJwtToken(token) {
            if (token && token.startsWith(_app_constants_app_constants_service__WEBPACK_IMPORTED_MODULE_5__["AppConstantsService"].JWT_PREFIX)) {
                localStorage.setItem(_app_constants_app_constants_service__WEBPACK_IMPORTED_MODULE_5__["AppConstantsService"].JWT_HEADER_NAME, JSON.stringify(token));
            }
        }
        function saveLastActiveTime() {
            var date = new Date().getTime();
            localStorage.setItem(_app_constants_app_constants_service__WEBPACK_IMPORTED_MODULE_5__["AppConstantsService"].LAST_ACTIVE_TIME, JSON.stringify(date));
        }
    };
    AbstractHttpClientService.prototype.handleError = function (error) {
        ...
        return rxjs_index__WEBPACK_IMPORTED_MODULE_7__["Observable"].throw(response); // response.error.message;
        function actOnServerStatusCode(statusCode) {
    ...
    AbstractHttpClientService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [String, String, _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"],
            _app_wide_service_app_wide_service__WEBPACK_IMPORTED_MODULE_6__["AppWideService"],
            _auth_service_auth_util_service__WEBPACK_IMPORTED_MODULE_4__["AuthUtilService"],
            _app_constants_app_constants_service__WEBPACK_IMPORTED_MODULE_5__["AppConstantsService"]])
    ], AbstractHttpClientService);
    return AbstractHttpClientService;
}());
...
/***/ "./src/app/shared/service/abstract-http-client/server-response.ts":
/*!************************************************************************!*\
  !*** ./src/app/shared/service/abstract-http-client/server-response.ts ***!
  \************************************************************************/
/*! exports provided: ServerResponse, Error */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ServerResponse = /** @class */ (function () {
    function ServerResponse(data, error) {
        this.data = data;
        this.error = error;
    }
...
//# sourceMappingURL=default~auth-auth-module~authenticated-authenticated-module~content-content-module~login-login-modul~68e9018c.js.map